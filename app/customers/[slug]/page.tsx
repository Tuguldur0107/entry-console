        ...
        <div className="space-y-4 lg:col-span-2">
          ...
          <Section title="Core шинэчлэлт" sub={`Харилцагчийн repo дээр upstream-sync.yml ажиллаж PR нээнэ · core ${latest?.tagName ?? "—"}`}>
            ...
            <div className="mt-4 border-t border-border pt-4">
              ...
              {access ? (
                <UpstreamAccessPanel slug={slug} granted={access.granted} keyOnCore={access.keyOnCore} secretOnRepo={access.secretOnRepo} pushKeyReady={access.pushKeyReady} canOpenPr={access.canOpenPr} />
              ) : (
