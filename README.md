...
| Хүснэгт | **Entry core-ийн хүснэгтийн стандарт**: жагсаалт бүр `components/datagrid/data-grid.tsx` (AG Grid Community v35, `--ea-*` theme) — эрэмбэлэх, нэрийн багана тогтмол, давхар даралт / Enter → дэлгэрэнгүй. Утсан дээр (<640px) хүснэгтийн оронд карт (`card` prop). Багана/картыг `components/grids/*`-д тодорхойлно; `<table>` гараар бичихийг `tests/datagrid-standard.test.ts` хориглоно |
...
| SaaS багцууд | Үндсэн SaaS сервис (entry-accounting, `ENTRY_DEPLOYMENT_MODE=saas`) дээрх байгууллага бүрийн багц / статус / суудал / trial · grace хугацаа / overrides — `/subscriptions` (жагсаалт л: ТТД, статус, багц, бичих эрх, хугацаа, дуусах огноо, суудал, гишүүд, үнэ, сарын дүн, AI нягтлан, эзэн, бүртгэсэн, тэмдэглэл; тоон үзүүлэлт + «анхаарах» мөрүүд САМБАРТ). Байгууллагыг **бүрмөсөн устгах** нь дэлгэрэнгүйн «Аюултай бүс» (нэрийг яг бичиж баталгаажуулна; өнчин гишүүдийг сонголтоор) — core `DELETE /api/platform/organizations`. Core-ийн `GET/PUT /api/platform/subscriptions` (Bearer `ENTRY_SAAS_API_KEY` = core-ийн `ENTRY_PLATFORM_API_KEY`, `ENTRY_SAAS_API_URL`); апп дотор platform admin UI байхгүй — багцыг ЗӨВХӨН энд удирдана, өөрчлөлт тэр даруй үйлчилнэ. Тусдаа сервисийн харилцагч (dedicated) энд ОРОХГҮЙ — тэднийг лицензээр удирдана |
| Багцын үнэ | `/subscriptions/pricing` — багц бүрийн ₮/суудал/сар **мөрдөх хугацаатайгаа** (deploy шаардахгүй, бүх харилцагчид үйлчилнэ): өнөөдрийн үнэ, шинэ үе нэмэх (хэзээнээс … хэзээ хүртэл эсвэл хугацаагүй), бүх үнийн түүх. Хугацаагүй үнэ дээр шинэ үнэ хожуу эхлэвэл өмнөх нь автоматаар хаагдана; давхцвал татгалзана. Харилцагчийн «Тусгай үнэ» нь үүнийг дардаг — тусгай үнэтэй БҮХ байгууллагыг энэ хуудсаас нэг хүснэгтээр харж, дурын байгууллагад нэмж/цэвэрлэж болно (байгууллагын өөрийн хуудсан дээрх талбар мөн хэвээр). Жагсаалтад MRR (идэвхтэй + хоцорсон; дүн тодорхойгүй бол нийлбэрт ОРОХГҮЙ, тусад нь тоологдоно) |
