...
| Багцын үнэ | `/subscriptions/pricing` — багц бүрийн ₮/суудал/сар (deploy шаардахгүй, бүх харилцагчид үйлчилнэ); харилцагчийн «Тусгай үнэ» нь үүнийг дардаг. Жагсаалтад MRR (идэвхтэй + хоцорсон; дүн тодорхойгүй бол нийлбэрт ОРОХГҮЙ, тусад нь тоологдоно) |
